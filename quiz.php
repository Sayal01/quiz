    ...
    <script>
        ...
        function navigateToNextQuestion() {
            ...
            if (currentQuestionIndex >= questionsCount) {
                ...
                document.getElementById("nextBtn").style.backgroundColor = "red"; 
        ...
        function navigateToPreviousQuestion() {
            if (currentQuestionIndex === questionsCount - 1) {
                document.getElementById("nextBtn").style.backgroundColor = "#f2f2f2"; 
                            ...
                            <ol class="options">
                                <li class="option">
                                    <label class="option-label">
                                        <input type="radio" name="answer[<?php echo $question['question_id']; ?>]" value="<?php echo $question['option1']; ?>">
                                        <?php echo $question['option1']; ?>
                                    </label>
                                </li>
                                <li class="option">
                                    <label class="option-label">
                                        <input type="radio" name="answer[<?php echo $question['question_id']; ?>]" value="<?php echo $question['option2']; ?>">
                                        <?php echo $question['option2']; ?>
                                    </label>
                                </li>
                                <li class="option">
                                    <label class="option-label">
                                        <input type="radio" name="answer[<?php echo $question['question_id']; ?>]" value="<?php echo $question['option3']; ?>">
                                        <?php echo $question['option3']; ?>
                                    </label>
                                </li>
                                <li class="option">
                                    <label class="option-label">
                                        <input type="radio" name="answer[<?php echo $question['question_id']; ?>]" value="<?php echo $question['option4']; ?>">
